...
public class LibroUtil {
	...
	public static Libro findByUuid_First(
		...
		throws com.sinenssia.business.exception.NoSuchLibroException {
	 ...
	 */
	public static List<com.sinenssia.business.model.Escritor> getEscritors(
		long pk) {
