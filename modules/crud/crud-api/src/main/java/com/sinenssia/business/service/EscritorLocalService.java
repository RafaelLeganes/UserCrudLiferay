...
public interface EscritorLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.sinenssia.business.service.impl.EscritorLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the escritor local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EscritorLocalServiceUtil} if injection and service tracking are not available.
	 */
