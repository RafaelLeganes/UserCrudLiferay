...
package com.sinenssia.business.service.base;
...
import com.sinenssia.business.service.EscritorLocalService;
import com.sinenssia.business.service.EscritorLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sinenssia.business.service.impl.EscritorLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.sinenssia.business.service.impl.EscritorLocalServiceImpl
 * @generated
 */
public abstract class EscritorLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EscritorLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EscritorLocalServiceUtil</code>.
	 */
	...
	public BasePersistence<Escritor> getBasePersistence() {
	...
	public List<Escritor> getLibroEscritors(
		...
		return libroPersistence.getEscritors(
	 ...
	 */
	public void setEscritorPersistence(
	 ...
	 */
	public com.sinenssia.business.service.LibroLocalService
	...
	public void setLibroLocalService(
		com.sinenssia.business.service.LibroLocalService libroLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.sinenssia.business.model.Escritor", escritorLocalService);

		_setLocalServiceUtilService(escritorLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.sinenssia.business.model.Escritor");
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = EscritorLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, escritorLocalService);
		}
	...
	@BeanReference(
		type = com.sinenssia.business.service.LibroLocalService.class
	)
	protected com.sinenssia.business.service.LibroLocalService
		libroLocalService;
